...
def matting(alpha_file, bgr_file, bg_file):
    ...
    cv.imwrite('images/new_compose.png', im)
    # cv.imwrite('images/new_new_bg.png', bg)
...
if __name__ == '__main__':
    ...
    total_loss = 0.0
    alpha_file = 'trimap/trimap_0001.jpg'
    bgr_file = 'ori/img_0001.jpg'
    bg_file = '0002.jpg'
